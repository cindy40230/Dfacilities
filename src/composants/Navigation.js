  ...
  <nav>
    ...
    <ul id="navMenu">     
      <li>
        ...
        <ul>
          <li>
          <NavLink to="/nos-domaines" className="link" exact title="lien vers la page domaine d'activité"> Nos domaine d'activité</NavLink>
          </li>
          <li>
          <NavLink to="/nos-partenaires" className="link" exact title="lien vers la page nos partenaires"> Nos partenaires</NavLink>
          </li>
        </ul>  
        </li>   
      <li>
        <label for="btn-2" className="show">Nos prestations +</label>
      ...
      <li>
        <label for="btn-3" className="show">Actualité +</label>
      ...
      <li>
        <label for="btn-4" className="show">Mon compte +</label>
      ...
      <li>
      <NavLink to="/contact" className="navLink" exact title="lien vers la page contact">Contact</NavLink>
      </li>
    </ul>
  </nav> 
  </header> 
